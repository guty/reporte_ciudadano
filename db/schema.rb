...
ActiveRecord::Schema.define(version: 20_220_131_031_430) do
  ...
  create_table 'complaints', force: :cascade do |t|
    ...
    t.index ['dependency_id'], name: 'index_complaints_on_dependency_id'
  ...
  add_foreign_key 'complaints', 'dependencies'
